...
const locationUrl = "https://c.climbing.is/climbingSearch/Location";
...
*/
  ...
  getMapEnabled() {
    return this.http.get<boolean>('https://data.climbing.is/mapEnabled.php');
  }

  getLocation() {
    return this.http.post<SwLocation>(locationUrl, {});
  }
